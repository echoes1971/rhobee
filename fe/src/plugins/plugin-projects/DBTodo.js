...
export function Todos() {
  ...
  return (
    <ObjectSearch  searchTitleLabel="plugin-projects.DBTodo" searchClassname={searchClassname} searchColumns={searchColumns} resultsColumns={resultsColumns} dark={dark} themeClass={themeClass} />
    );
}

...
export function Projects() {
  ...
  return (
    <ObjectSearch searchTitleLabel="plugin-projects.DBProject" searchClassname={searchClassname} searchColumns={searchColumns} resultsColumns={resultsColumns} dark={dark} themeClass={themeClass} />
    );
}
